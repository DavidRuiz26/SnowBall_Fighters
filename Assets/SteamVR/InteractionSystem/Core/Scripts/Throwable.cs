...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Throwable : MonoBehaviour
    {
        ...
        private float velocityMultiplicator = 2.25f;
        ...
        protected virtual void OnDetachedFromHand(Hand hand)
        {
            ...
            rigidbody.velocity = velocity * velocityMultiplicator;
            rigidbody.angularVelocity = angularVelocity * velocityMultiplicator;
        }
